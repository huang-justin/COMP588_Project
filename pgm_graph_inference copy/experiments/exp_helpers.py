...
data_specs.update({struct+"_small": {struct: [100]} for struct in struct_names})

# add simple datasets
#data_specs.update({struct+"_small": {struct: [30]} for struct in struct_names})
data_specs.update({struct+"_30": {struct: [30]} for struct in struct_names})
